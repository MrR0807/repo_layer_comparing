...
public class SelectEmployeesFullGraph {

    private static final String SELECT_ALL_EMPLOYEES_FULL_GRAPH = """
    ...
    public static String preparedStatementSQL() {
        return SELECT_ALL_EMPLOYEES_FULL_GRAPH;
    }

    public static Select<Set<Employee>> select() {
        return SelectEmployeesFullGraph::extractEmployees;
    }
